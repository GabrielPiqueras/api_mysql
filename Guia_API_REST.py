...
# Instalo nodemon como dependencia solo para el desarrollo (-D)
# Nodemos me permite ejecutar mi servidor sin necesidad de estar reiniciandolo
npm i nodemon -D

# Instalo express como dependencia de desarrollo
npm i nodemon -D

# Creo un archivo 'app.js' en la raíz, donde estará toda la lógica y funcionalidad de mi API
